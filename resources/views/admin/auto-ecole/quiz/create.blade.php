            ...
            <form action="{{ route('admin.auto-ecole.quiz.store') }}" method="POST" class="p-6 md:p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="question" 
                                  ...
                                  required
                                  rows="3"
                                  class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all duration-200 @error('question') border-red-500 @enderror">{{ old('question') }}</textarea>
                        @error('question')
                            <p class="mt-2 text-sm text-red-600 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                                {{ $message }}
                            ...
                            <template x-for="(option, index) in options" :key="index">
                                <div class="bg-gray-50 rounded-lg p-4 border-2 border-gray-200">
                                    <div class="flex items-start gap-3">
                                        <!-- Checkbox avec gestion correcte de la valeur -->
                                        <input type="hidden" 
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t border-gray-200">
                    <button type="submit" 
                        ...
                        {{ $isFrench ? 'Créer le quiz' : 'Create quiz' }}
                    </button>
