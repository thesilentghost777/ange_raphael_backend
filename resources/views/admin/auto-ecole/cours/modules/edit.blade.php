...
@section('title', $isFrench ? 'Modifier le Module' : 'Edit Module')
...
<div class="min-h-screen bg-gradient-to-br from-amber-50 via-white to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    <h1 class="text-3xl md:text-4xl font-bold text-gray-900">
                        ...
                        {{ $isFrench ? 'Modifier le Module' : 'Edit Module' }}
                    </h1>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <form action="{{ route('admin.auto-ecole.cours.modules.update', $module->id) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" id="nom" name="nom" value="{{ old('nom', $module->nom) }}" required
                ...
                <div>
                    ...
                    <input type="number" id="ordre" name="ordre" value="{{ old('ordre', $module->ordre) }}" min="1" required
                           class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200">
                </div>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                              class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200">{{ old('description', $module->description) }}</textarea>
                </div>
